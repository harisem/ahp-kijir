<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item {{ request()->routeIs('berita.*') ? 'active' : '' }}">
        <a class="nav-link {{ request()->routeIs('berita.*') ? '' : 'collapsed' }}" href="#" data-toggle="collapse" data-target="#collapseTwo"
    ...
    <li class="nav-item {{ request()->routeIs('user.*') ? 'active' : '' }}">
        <a class="nav-link {{ request()->routeIs('user.*') ? '' : 'collapsed' }}" href="#" data-toggle="collapse" data-target="#collapseUtilities"
            aria-expanded="true" aria-controls="collapseUtilities">
            <i class="fas fa-fw fa-users"></i>
            <span>Kelola Akun Pengguna</span>
        </a>
        <div id="collapseUtilities" class="collapse {{ request()->routeIs('user.*') ? 'show' : '' }}" aria-labelledby="headingUtilities"
    ...
    <li class="nav-item {{ request()->routeIs('beasiswa.*') ? 'active' : '' }}">
        <a class="nav-link {{ request()->routeIs('beasiswa.*') ? '' : 'collapsed' }}" href="#" data-toggle="collapse" data-target="#collapsePages"
